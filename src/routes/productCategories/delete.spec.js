...
describe('DELETE product category', () => {
  ...
  describe('DELETE /productCategories/{key}', () => {
    ...
    it('should return 204, for admin, if category was successfully removed', (done) => {
      request(server)
        .delete(`/v4/productCategories/${key}`)
        .set({
          Authorization: `Bearer ${testUtil.jwts.admin}`,
    ...
    it('should return 204, for connect admin, if category was successfully removed', (done) => {
      request(server)
        .delete(`/v4/productCategories/${key}`)
        .set({
